...
public class EventConverter {
    ...
    public Optional<Phenomena> convert(OntModel m, Event event) {
        ...
        Optional<Phenomena> phenomena = eventRepository
                .createEvent(m, eventLink.orElseGet(this::generateEventURI));
     ...
     */
    private List<OntClass> getPhenomenaClasses(List<EventCategory> categories) {
